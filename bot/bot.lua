...
----------###################### START LOCKS ########################------------
  if text and is_Mod(msg) then
		if (text:match("^(lock) (.*)$") or text:match("^(قفل) (.*)$")) and is_JoinChannel(msg) then 
		...
		if LockName == 'بازی اینلاین' or LockName:lower() == 'inlinegame' then
		...
		if LockName == 'فوروارد از کانال' or LockName:lower() == 'forwardchannel' then
		...
		if LockName == 'فوروارد کاربر' or LockName:lower() == 'forwarduser' then
       ...
       if text and is_Mod(msg) then
		...
		if UnlockName == 'فوروارد از کانال' or UnlockName:lower() == 'forwardchannel' then
		...
		if UnlockName == 'فوروارد کاربر' or UnlockName:lower() == 'forwarduser' then
...
if text == 'unsilentuser' or text == 'لغو سکوت' and is_JoinChannel(msg) then
function Restricted(FreemanagerBOT,result)
if tonumber(result.sender_user_id) == tonumber(TD_ID) then
sendText(msg.chat_id, msg.id,  '> خطا!\nشما دسترسی لازم برای محدود سازی سایر مالکان/مدیران را ندارید.', 'md')
return false
...
if text and text:match('^unsilentuser (%d+)$') or text and text:match('^لغو سکوت (%d+)$') and is_JoinChannel(msg) then
